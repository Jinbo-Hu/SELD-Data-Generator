...
def get_params(arg=0):
    ...
    params = dict(
        ...
        mixturepath = './DataSynth/', # root path to the mixture files
        db_name = 'sound_event1', # run data_generator/db_config.py .obj file
        db_path = './sound_event_datasets', # path to the dataset
